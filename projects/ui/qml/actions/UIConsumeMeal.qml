...
UIActionForm {
  ...
  activateData : builderMode ? {"name" : "ConsumeMeal", "time" : actionStartTime_s, "carbs_g" : carbs_g, "fat_g" : fat_g, "protein_g" : protein_g, "sodium_mg" : sodium_mg, "calcium_mg" : calcium_mg, "water_mL" : water_mL} : ({})
