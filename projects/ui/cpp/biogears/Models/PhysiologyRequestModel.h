...
class PhysiologyRequestModel : public QAbstractItemModel {
...
public:
  ...
  PhysiologyRequestModel(QString prefix, QString name, QAbstractItemModel* parent = nullptr);

  ~PhysiologyRequestModel() override;
